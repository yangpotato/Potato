...
public class SearchAlbumAdapter extends BaseQuickAdapter<Album, BaseViewHolder> {

    private Context mContext;

    public SearchAlbumAdapter(Context context, @Nullable List<Album> data) {
...
//        int width = screenWidth / 2;
        Glide.with(mContext).load(item.getImg()).into((ImageView) helper.getView(R.id.img_item_home));
